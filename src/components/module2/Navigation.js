...
const Navigation = () => {
    ...
    const [isWindComplete, setIsWindComplete] = useState(state => state?.module2?.wind);
    const [isSolarPvBESSComplete, setIsSolarPvBESSComplete] = useState(state => state?.module2?.solarPvBess);
    const [isBiomassComplete, setIsBiomassComplete] = useState(state => state?.module2?.biomass);
    const [isCHPComplete, setIsCHPComplete] = useState(state => state?.module2?.chp);
    const [isLEDComplete, setIsLEDComplete] = useState(state => state?.module2?.led);
    const [isPassiveInfraredSensorComplete, setIsPassiveInfraredSensorComplete] = useState(state => state?.module2?.passiveInfraredSensor);
    const [isSmartMetersElectricityComplete, setIsSmartMetersElectricityComplete] = useState(state => state?.module2?.smartMetersElectricity);
    const [isSmartMetersGasComplete, setIsSmartMetersGasComplete] = useState(state => state?.module2?.smartMetersGas);
    const [isVoltageOptimisationComplete, setIsVoltageOptimisationComplete] = useState(state => state?.module2?.voltageOptimisation);
    const [isEnergyManagementSystemComplete, setIsEnergyManagementSystemComplete] = useState(state => state?.module2?.energyManagementSystem);
    const [isSolarThermalComplete, setIsSolarThermalComplete] = useState(state => state?.module2?.solarThermal);
    const [isIndustrialHeatPumpComplete, setIsIndustrialHeatPumpComplete] = useState(state => state?.module2?.industrialHeatPump);
